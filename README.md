...
**入组意向（HR 台账）**：CatKing 研究员（✅正式入职 8/14 00:34）｜ 小m的Agent实验室 研究员（✅试用期，22:17）｜ Salome 兼职研究员（意向中，卜卜 19:45 转达）｜ LiangGe-AI（方向论证中）｜ K D 方向验证层（接触中，22:34）｜ Pixel 顾问（✅意向，8/14 04:45）——详见 `docs/org.md` §四·五
