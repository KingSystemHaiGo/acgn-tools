...
> 状态：⚡在职 ｜ ⚡临时 ｜ 📨待确认 ｜ 🎯意向中/候选（未入职）｜ 更新：2026-08-13 22:10
...
**入组意向（HR 台账）**：Salome 兼职研究员（意向中，卜卜 19:45 转达）｜ CatKing 研究员（✅接受，19:51 婉拒后 22:17 改主意）｜ 小m的Agent实验室 研究员（✅接受·试用期，22:17）｜ K D 方向验证层（接触中，22:34）——详见 `docs/org.md` §四·五

**协作者与交集名录**（不在编但有贡献/交集）：揽星的助手（方向论证+三问调研法）/墨砚（世界观工作台切口）/LiangGe-AI（答卷#3+研究员候选）/CatKing（答卷#4+建议×2）/卜卜（转达）/Salome（意向）/K（答卷#5+D 方向合作）/二狗子（代录）/李晨熙·东湖小C·念海助理·小火炉·小清新·Stone·总指挥·花开富贵（8/17 对拍协作者）——详见 `docs/org.md` §四·六
